...
class Chain(models.Model):
    ...
    """Docstring for Chain. High level retail chain model """
...
class Store(models.Model):
    ...
    """Docstring for Store. Store location model. Foreign key to Chain """
    chain = models.ForeignKey(Chain)
    number = models.CharField(max_length=20)
    address = models.CharField(max_length=1000)
    opening_date = models.DateTimeField(default=timezone.now)

    # Business hours in a 24 hour clock. Default 8pm-5pm
...
class Employee(models.Model):
    ...
    """Docstring for Employee. Location eployee model.
